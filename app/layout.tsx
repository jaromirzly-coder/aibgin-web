...
export default function RootLayout({
  ...
  return (
    <html lang="cs" className={inter.className}>
      ...
      <body>
        <div style={{background:'#1a1a2e',color:'#ffffff',textAlign:'center',padding:'20px 24px',fontSize:'16px',lineHeight:'1.6',borderBottom:'4px solid #7c3aed',fontWeight:'500'}}>
          Z důvodu nečekaně velkého zájmu jsme uzavřeli přihlašování do pilotního programu AIBgin. Omlouváme se dalším zájemcům — nabídneme prázdninový testovací program, který zveřejníme včas před začátkem prázdnin.
        </div>
        {children}
        <CookieConsent />
        <CookieBanner />
